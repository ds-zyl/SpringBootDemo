...
/**
 * Rest接口样例：以@Controller和@RequestMapping标签开发的Rest接口
 */
@Controller
@RequestMapping("/api0")
public class RestApiBasicController_V0 {
	
	/**
	 * GET 方式请求 /api0/listitem 返回用户列表
	 * http://localhost:8080/api0/listItem
	 */
	...
	/**
	 * GET 方式请求 /api0/item/1返回id为1的用户
	 * http://localhost:8080/api0/item/0
	 */
	...
	/**
	 * POST 方式请求 /api0/item 通过item对象的JSON 参数创建新的item对象
	 * http://localhost:8080/api0/item
	 */
	...
	/**
	 * PUT 方式请求 /api0/item/1 更新id为1的发送json格式的用户对象
	 * http://localhost:8080/api0/item/0
	 */
	...
	/**
	 * DELETE 方式请求/api0/item/4删除 ID为 4的item对象
	 * http://localhost:8080/api0/item/0
	 */
	...
	/**
	 * DELETE 方式请求/api0/item/删除所有item
	 * http://localhost:8080/api0/item
	 */
